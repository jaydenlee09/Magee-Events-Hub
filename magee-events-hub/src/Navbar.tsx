  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="font-bold text-lg tracking-tight text-gray-800 dark:text-gray-100 select-none">Magee Events Hub</span>
      </div>
      <div className="flex items-center gap-4">
        <Link
          ...
          `}
        >
          <FaCalendarAlt size={20} color={darkMode ? '#fff' : undefined} />
          <span>Events</span>
        </Link>
        <Link
          to="/schedule"
          ...
          `}
        >
          <PiStudent size={20} color={darkMode ? '#fff' : undefined} />
          <span>Calendar</span>
        </Link>
        <Link
          to="/submit"
          ...
          `}
        >
          <IoMdAdd size={20} color={darkMode ? '#fff' : undefined} />
        ...
        {isAdmin && (
          <button className="flex items-center gap-1 px-4 py-2 rounded-lg font-medium text-gray-500 hover:bg-gray-200 hover:text-red-700 transition-all duration-200 ease-in-out hover:scale-105 active:scale-95 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-red-200" onClick={handleLogout}>
            Logout
          </button>
        )}
        {/* Dark mode toggle */}
